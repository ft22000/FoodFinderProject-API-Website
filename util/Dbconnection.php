 ...
 */
	...
	$USERNAME = "FoodFinderWebClient"; // The username to be used when connecting to the MySQL database
	$PASSWORD = "f00Df1nd3r!"; // The password to be used when connecting to the MySQL database
